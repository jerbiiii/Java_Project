...
<main class="container main-content fade-in">
    <div class="page-header">
        <h2 class="mb-0"><i class="fas fa-layer-group me-2"></i>Liste des Domaines</h2>
        <div class="d-flex gap-2">
            ...
            <a href="${pageContext.request.contextPath}/domaines?action=new" class="btn btn-primary">
                <i class="fas fa-plus-circle me-2"></i>Nouveau Domaine
            </a>
        </div>
    </div>
