...
<main class="container main-content fade-in">
    <div class="page-header">
        <h2 class="mb-0"><i class="fas fa-briefcase me-2"></i>Liste des Employeurs</h2>
        <div class="d-flex gap-2">
            ...
            <a href="${pageContext.request.contextPath}/employeurs?action=new" class="btn btn-primary">
                <i class="fas fa-plus-circle me-2"></i>Nouvel Employeur
            </a>
        </div>
    </div>
                    ...
                    <c:forEach var="employeur" items="${employeurs}">
                        <tr>
                            ...
                            <td class="text-end action-buttons">
                                <a href="${pageContext.request.contextPath}/employeurs?action=edit&id=${employeur.id}"
                                   class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit me-1"></i>Modifier
                                </a>
                                <a href="${pageContext.request.contextPath}/employeurs?action=delete&id=${employeur.id}"
                                   class="btn btn-sm btn-danger"
                                   onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet employeur ?')">
