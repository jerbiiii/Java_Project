...
<main class="container main-content fade-in">
    <div class="page-header">
        <h2 class="mb-0"><i class="fas fa-id-badge me-2"></i>Liste des Profils</h2>
        <div class="d-flex gap-2">
            ...
            <a href="${pageContext.request.contextPath}/profils?action=new" class="btn btn-primary">
                <i class="fas fa-plus-circle me-2"></i>Nouveau Profil
            </a>
        </div>
    </div>
                    ...
                    <c:forEach var="profil" items="${profils}">
                        <tr>
                            ...
                            <td class="text-end action-buttons">
                                <a href="${pageContext.request.contextPath}/profils?action=edit&id=${profil.id}"
                                   class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit me-1"></i>Modifier
                                </a>
                                <a href="${pageContext.request.contextPath}/profils?action=delete&id=${profil.id}"
