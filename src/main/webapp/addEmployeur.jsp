        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="mb-0">
                    ...
                    ${not empty employeur ? 'Modifier' : 'Ajouter'} Employeur
                </h3>
            </div>
            <div class="card-body p-4">
                <form action="employeurs" method="post">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">Nom de l'employeur</label>
                        <input type="text" name="nomEmployeur" value="${employeur.nomEmployeur}"
                               class="form-control form-control-lg" required>
                    </div>

                    <div class="d-flex justify-content-end gap-3">
                        <a href="${pageContext.request.contextPath}/employeurs"
