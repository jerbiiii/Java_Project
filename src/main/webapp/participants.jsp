...
<main class="container main-content fade-in">
    <div class="page-header">
        <h2 class="mb-0"><i class="fas fa-user-graduate me-2"></i>Liste des Participants</h2>
        <div class="d-flex gap-2">
            ...
            <a href="${pageContext.request.contextPath}/participants?action=new" class="btn btn-primary">
                <i class="fas fa-plus-circle me-2"></i>Nouveau Participant
            </a>
        </div>
    </div>
                ...
                <tbody>
                    <c:forEach var="participant" items="${participants}">
                        <tr>
                            ...
                            <td><span class="badge bg-secondary">${participant.structure.libelle}</span></td>
                            <td><span class="badge bg-primary">${participant.profil.libelle}</span></td>
                            <td>${participant.email}</td>
                            <td>${participant.tel}</td>
                            <td class="text-end action-buttons">
                                <a href="${pageContext.request.contextPath}/participants?action=edit&id=${participant.id}"
                                   class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit me-1"></i>Modifier
                                </a>
                                <a href="${pageContext.request.contextPath}/participants?action=delete&id=${participant.id}"
